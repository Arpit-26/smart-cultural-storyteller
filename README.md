...
# 🎬 Demo Outputs (Sample Results)

Below are sample outputs generated by Smart Cultural Storyteller.

### 🖼️ Scene-wise Image Generation

Each sentence in the story is converted into a visual scene using Pollinations.ai.
<p float="left">
  <img src="demo_outputs/images/scene_01.png" width="250" />
  <img src="demo_outputs/images/scene_05.png" width="250" />
  <img src="demo_outputs/images/scene_03.png" width="250" />
  <img src="demo_outputs/images/scene_06.png" width="250" />
   <img src="demo_outputs/images/scene_07.png" width="250" />
  <img src="demo_outputs/images/scene_08.png" width="250" />

</p>


### 🎙️ Audio Narration (Regional Accent)

Narration generated using ElevenLabs with Indian regional accent (Punjabi).

🔊 [Sample Audio]:
demo_outputs/audio/video_story_audio(Punjabi accent).mp3

### 🎥 Final Story Video

The video is created by combining scene-wise images and full narration using FFmpeg.

📺 [Watch Full Video (MP4)](demo_outputs/video/cultural_story_demo.mp4)
: demo_outputs/video/cultural_story_demo.mp4
